...
public class TreeSet<T> implements SortedSet<T> {
	...
	private void swapTree(Node<T> root) {
		swapEveryNode(root, 1);
	}

	private void swapEveryNode(Node<T> root, int level) {
		...
		swapEveryNode(root.left, level + 1);
		swapEveryNode(root.right, level + 1);
	}
}
